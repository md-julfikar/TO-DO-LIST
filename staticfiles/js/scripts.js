function showTaskDetail(taskId) {
    fetch(`/task/${taskId}/detail/`)
        ...
        .then(data => {
            ...
            document.getElementById('taskDetailDueDate').innerText = `Due Date: ${data.due_date ? data.due_date : '----'}`;
            document.getElementById('taskDetailDescription').innerText = `Details: ${data.details ? data.details : '----'}`;
